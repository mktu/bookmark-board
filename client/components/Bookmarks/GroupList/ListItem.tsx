...
const ListItem: React.FC<Props> = ({
    ...
    return (
        ...
        }} className={classNames(`w-full overflow-hidden flex text-primary-main items-center p-2 cursor-pointer hover:text-primary-dark hover:bg-primary-hover focus:outline-none ${selected && 'md:bg-primary-hover'}`,
