    ...
    return (
        <div className='text-sm'>
            <div className='flex items-center my-2'>
                ...
                <TextInputBase value={`${requestUrl}`} readOnly className='hidden md:inline-block flex-1 p-2 mx-2 w-full rounded border border-primary-border' ></TextInputBase>
                <div className='md:hidden mx-2 text-primary-500' >共同編集リンク</div>
