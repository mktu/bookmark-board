...
const NotificationMenu = () => {
    ...
    return (
        <div className='bg-white opacity-80 rounded shadow-lg border border-primary-border overflow-hidden flex flex-col justify-start align-middle pb-1' style={{width:256}}>
            <div className='flex items-center w-full text-primary-main bg-primary-light md:bg-primary-main justify-center p-2 md:text-white border-b border-primary-border'>
