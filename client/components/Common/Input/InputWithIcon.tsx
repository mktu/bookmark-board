    ...
    ...props
        ...
        return (
            <div className="flex relative flex-wrap items-stretch w-full">
                ...
                <input {...props} type="text" className="relative py-3 px-3 pl-10 w-full md:text-sm placeholder-primary-200 text-primary-700 bg-white rounded shadow outline-none focus:outline-none focus:shadow-outline" />
            </div>
        )
    }
