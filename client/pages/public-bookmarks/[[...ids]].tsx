  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:image" content={`https://og-image-lilac-kappa.vercel.app/%3Ch3%3E${group.name}%3C%2Fh3%3E%40${profile.name}.png?md=1`} />
        ...
        <meta name="twitter:image" content={`https://og-image-lilac-kappa.vercel.app/%3Ch3%3E${group.name}%3C%2Fh3%3E%40${profile.name}.png?md=1`} />
      </Head>
      <PublicLayout
        header={<Header />}
